...
<template>
  <div id="bg">
    <header>
      <div id="navBar">
        <div id="navs" :key="nav" v-for="nav in navBars" :class="{contactLink: nav === 'Liên Hệ Ngay'}"><h4>{{ nav }}</h4></div>
      </div>
    </header>
    ...
    <footer>
      <div id="footer--background" :key="index" v-for="(footer, index) in footers">
        <div>
